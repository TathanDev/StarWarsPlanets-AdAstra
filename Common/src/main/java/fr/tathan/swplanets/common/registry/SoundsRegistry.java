...
public class SoundsRegistry {
    ...
    public static final RegistryEntry<SoundEvent> LIGHT_SABER_SOUND_1 = SOUNDS.register("light_saber_sound_1", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Constants.MODID, "light_saber_sound_1")));
    public static final RegistryEntry<SoundEvent> LIGHT_SABER_SOUND_2 = SOUNDS.register("light_saber_sound_2", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Constants.MODID, "light_saber_sound_2")));
    public static final RegistryEntry<SoundEvent> LIGHT_SABER_SOUND_3 = SOUNDS.register("light_saber_sound_3", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Constants.MODID, "light_saber_sound_3")));
